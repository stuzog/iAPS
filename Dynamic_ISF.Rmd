...
You may need to tweak your *AdjustmentFactor*, as the curve changes with the new formula, so the Adjustment Factor does change as well.
...
**Basically, *AutoSens* determines how sensitive/resistant you are compared to the system baseline**. An `AutoSens` value of `1` means that your sensitivity is what the system expects.

* **More than `1`** means that you're needing **more insulin** than the baseline
